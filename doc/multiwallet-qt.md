...
In order to support loading of multiple wallets in digiwage-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is digiwage.cpp.
...
Changes to digiwage.cpp
----------------------
digiwage.cpp is the entry point into digiwage-qt, and as such, will require some minor modifications to provide hooks for
