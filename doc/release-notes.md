Worx Core version 2.3.1 is now available from:
...
Worx Core is extensively tested on multiple operating systems using
...
Worx Core should also work on most other Unix-like systems but is not
