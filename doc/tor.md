...
It is possible to run Worx as a Tor hidden service, and connect to such services.
...
Run Worx behind a Tor proxy
----------------------------------

The first step is running Worx behind a Tor proxy. This will already make all
