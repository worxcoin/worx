...
Once dependencies are compiled, see release-process.md for how the Worx-Qt.app
...
commands:
    ...
    echo -e "rpcuser=digiwagerpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Worx/digiwage.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Worx/digiwage.conf"
