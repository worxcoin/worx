/* src/config/worx-config.h.  Generated from worx-config.h.in by configure.  */
/* src/config/worx-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WORX_CONFIG_H

#define WORX_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.worxs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Worx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Worx Core 1.1.0"
