...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-worx executable and locales:
    Delete /REBOOTOK $INSTDIR\worx.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\worx-qt.exe
    ...
    WriteRegStr HKCR "worx" "URL Protocol" ""
    WriteRegStr HKCR "worx" "" "URL:WORX"
    WriteRegStr HKCR "worx\DefaultIcon" "" $INSTDIR\worx-qt.exe
    WriteRegStr HKCR "worx\shell\open\command" "" '"$INSTDIR\worx-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\worx-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\WORX.lnk"
